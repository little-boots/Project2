...
# Route to Distributors Sankey Diagram Visualization
@app.route("/sankey")
def sankey():
    return render_template("sankey.html")

# Route to Trends Chart.js Visualization
@app.route("/chartjs")
def chartjs():
    return render_template("chartjs.html")

# Route to Pharmacies > Heat Map Visualization
@app.route("/heatmap")
def heat():
    """Return the homepage."""
    return render_template("heat.html")

# Route to Pharmacies > Marker Map Visualization
@app.route("/markermap")
def marker():
    """Return the homepage."""
    return render_template("marker.html")

# Route to Pharmacies > Cluster Map Visualization
...
# Used by: Manufacturers Choropleth Visualization
#------------------------------------------------
# API endpoint that returns average number
...
# Used by: Sankey and Chart.js Visualization
#------------------------------------------------
# API endpoint to get data for the state dropdown menus
@app.route("/states")
def states():
...
# Used by: Sankey and Chart.js Visualization
#------------------------------------------------
# API edpoint provides the data for the county dropdown for a given state
...
# Used by: Sankey Data Visualization
#------------------------------------------------
# API endpoint to provide Sankey chart data for a given state and county
...
# Used by: Chart.js Visualization
#------------------------------------------------
# API edpoint provides the data for the county dropdown for a given state
# Route provides the line chart data for a given state and county
...
# Used by: Heat, Marker, and Cluster Map Visualization
#------------------------------------------------
# API endpoint to get data for heat, marker and cluster map
@app.route("/heatlist")
def heatlist():
